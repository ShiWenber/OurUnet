...
class UNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        # SEattention channel是feature map的通道数，reduction是降维后的通道数
        self.seattention = SEAttention(channel=512, reduction=16)
    ...
    def forward(self, x):
        ...
        self.features['attention_weight'] = self.seattention.attention_weight
        self.features['xm'] = xm
